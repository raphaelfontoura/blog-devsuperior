...
| [`lidando-com-falhas-em-mensageria-dlq-e-retentativas-no-aws-sqs`](articles/lidando-com-falhas-em-mensageria-dlq-e-retentativas-no-aws-sqs/) | Lidando com falhas em mensageria, DLQ e Retentativas no AWS SQS | Java, Spring Boot, AWS, SQS, SNS, Docker, Localstack | `localstack`, `ms-ticket-ingestor`, `ms-reservation-handler`, `ms-notification`, `ms-fulfillment` |
