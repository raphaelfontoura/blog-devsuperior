...
| [`mensageria-e-dlq-retentativas-e-redrive`](articles/mensageria-e-dlq-retentativas-e-redrive/) | Mensageria, DLQ, Retentativas e Redrive | Java, Spring Boot, AWS, SQS, SNS, Docker, Localstack | `localstack`, `ms-ticket-ingestor`, `ms-reservation-handler`, `ms-notification`, `ms-fulfillment` |
